...
export const anomalies: Anomaly[] = [
  ...
  },
  {
    ...
    corrections: [
      { id: 'cr001', anomalyId: 'a003', note: '已补录病例信息，患者张某于8月12日行种植手术，因系统延迟未能及时录入。', attachmentName: '出库单_ZB-2025-0505-Q.pdf', submittedBy: '深圳南山店-周颖', submittedAt: '2025-08-16 09:30' },
    ],
  },
  {
    id: 'a004',
  ...
  },
  {
    ...
    corrections: [
      { id: 'cr002', anomalyId: 'a007', note: '经核查为护士录入时选错批号，实际使用批号为DT-2025-0620-R，已更正系统记录。', attachmentName: '更正记录_DT-2025-0110-U.png', submittedBy: '武汉江汉店-林薇', submittedAt: '2025-08-09 10:15' },
    ],
  },
  {
    id: 'a008',
    ...
    description: '种植体有效期2026-05-15早于手术日期2026-08-20，手术时种植体已过期',
    caseId: 'c008',
    patientName: '孙雅婷',
    doctorName: '陈伟强',
    surgeryDate: '2025-07-25',
  ...
  },
  {
    ...
    description: '种植体有效期2026-04-15早于手术日期2026-07-10，手术时种植体已过期',
    caseId: 'c018',
    patientName: '韩志强',
    doctorName: '陈雅婷',
    ...
    corrections: [
      { id: 'cr003', anomalyId: 'a009', note: '已更换为有效期内的同规格种植体，原批次已退回供应商。', attachmentName: '退回凭证_DS-2024-1015-02.pdf', submittedBy: '深圳南山店-吴婷', submittedAt: '2025-08-22 11:00' },
    ],
  },
  {
    id: 'a010',
    ...
    description: '种植体有效期2026-03-05接近手术日期，手术时距过期仅余7天',
    caseId: 'c023',
    patientName: '许文博',
    doctorName: '周逸飞',
    surgeryDate: '2025-07-20',
  ...
  },
  {
    ...
    description: '种植体有效期2026-05-30早于手术日期2026-07-25，手术时种植体已过期',
    caseId: 'c029',
    patientName: '曹美玲',
    doctorName: '孙婉清',
  ...
  },
  {
    ...
    corrections: [
      { id: 'cr004', anomalyId: 'a014', note: '系统规格字段已修正为4.0x11.5mm，与实际使用一致。', attachmentName: '规格更正截图.png', submittedBy: '南京鼓楼店-何霞', submittedAt: '2025-08-21 09:45' },
    ],
  },
  {
    id: 'a015',
